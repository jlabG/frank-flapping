class Player {
    ...
    draw() {
        this.game.ctx.drawImage(this.image, 0, this.frameY * this.spriteHeight, this.spriteWidth,
            this.spriteHeight, this.x, this.y, this.width, this.height);
        if (this.game.debug) {
            this.game.ctx.beginPath();
            this.game.ctx.arc(this.collisionX + this.collisionRadius, this.collisionY,
    ...
    flap() {
        ...
        if (!this.isTouchingTop()) {
            ...
            this.game.sound.play(this.game.sound.flapSounds
