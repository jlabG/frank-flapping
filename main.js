class Game {
    constructor(canvas, context) {
        ...
        window.addEventListener('resize', e => {
            this.resize(e.currentTarget.innerWidth, e.currentTarget.
                innerHeight);
        });
        ...
        window.addEventListener('keydown', e => {
            ...
            if (e.key.toLowerCase() === 'r') this.resize(window.innerWidth,
                window.innerHeight);
        ...
        this.canvas.addEventListener('touchmove', e => {
            if (e.changedTouches[0].pageX - this.touchStartX >
                this.swipeDistance) {
                this.player.startCharge();
            }
        })
    ...
    createObstacles() {
        ...
        for (let i = 0; i < this.numberOfObstacles; i++) {
            this.obstacles.push(new Obstacle(this, firstX + i *
                obstacleSpacing));
        }
    }
    formatTimer() {
    ...
    triggerGameOver() {
        if (!this.gameOver) {
            ...
            if (this.obstacles.length <= 0) {
                ...
                this.message2 = "Can you do it faster than " +
                    this.formatTimer() + ' seconds?';
            } else {
                this.sound.play(this.sound.lose);
                this.message1 = "Getting rusty?";
                this.message2 = "Collision time " + this.formatTimer()
                    + ' seconds!';
            }
        }
    }
    ...
    drawStatusText() {
        ...
        if (this.gameOver) {
            ...
            this.ctx.fillText("Press 'R' to try again!", this.width * 0.5,
